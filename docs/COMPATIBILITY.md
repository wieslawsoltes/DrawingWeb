# Visio compatibility matrix — 0.1.0-alpha.2
...
| Text | Rich runs, basic paragraphs/bullets, text blocks, cached fields and styled editing | Character/Paragraph and cached-field projection is a subset; full fields, typography, bidi and vertical fidelity remain incomplete |
